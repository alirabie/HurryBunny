...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, app, events, toastCtrl, modelCtrl, navParams, diagnostic, genrator, splashScreen, geo, googleMaps, altCtrl, menu, translate, viewCtrl, config, alertCrtl, platform, locationAccuracy) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.app = app;
        this.events = events;
        ...
        platform.ready().then(function () {
            ...
            diagnostic.isLocationEnabled().then(function (status) {
                if (!status) {
                    ...
                    // this.enableLocation();
                    _this.presentToast(translate.instant('locationalert'));
                }
                else {
                    _this.loadMap();
                }
    ...
    HomePage.prototype.loadMap = function () {
        ...
        this.geo.getCurrentPosition({ enableHighAccuracy: true }).then(function (resp) {
            ...
            _this.loadOfflineMap();
            _this.presentToast(_this.translate.instant('locationalert'));
        });
    };
